...
inline static void *prepare_out_buffer(void *original_buffer, size_t size)
{
	ARG_UNUSED(size);
	return original_buffer;
}

inline static void release_out_buffer(void *original_buffer, void *out_buffer, size_t size)
{
