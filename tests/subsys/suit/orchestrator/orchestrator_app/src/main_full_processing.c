...
static const uint8_t payload1[16] = {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99,
				     0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x11};
static const uint8_t payload2[30] = {0x1c, 0xf2, 0x76, 0xbd, 0x54, 0xc0, 0xb6, 0x82, 0xaf,
				     0xeb, 0xe9, 0x89, 0xb4, 0x5f, 0x96, 0xde, 0x0f, 0x81,
				     0x6a, 0xd7, 0xf6, 0x04, 0xcb, 0xe4, 0x94, 0xef, 0xa4,
				     0x3b, 0xf0, 0x4f};
...
FAKE_VALUE_FUNC(suit_ssf_err_t, suit_check_installed_component_digest, suit_plat_mreg_t*, int,
		suit_plat_mreg_t*);
FAKE_VALUE_FUNC(suit_ssf_err_t, suit_get_supported_manifest_roles, suit_manifest_role_t*, size_t*);
FAKE_VALUE_FUNC(suit_ssf_err_t, suit_get_supported_manifest_info, suit_manifest_role_t,
		suit_ssf_manifest_class_info_t*);

static const suit_manifest_role_t supported_roles[]
	= {SUIT_MANIFEST_APP_ROOT, SUIT_MANIFEST_APP_LOCAL_1};
...
suit_ssf_err_t suit_get_supported_manifest_info_custom_fake(suit_manifest_role_t role,
...
{
	suit_trigger_update_fake.custom_fake =
		suit_update_trigger_custom_fake_correct_function;
...
static void check_cache_slot_content(uint8_t cache_partition_id, const uint8_t *uri,
				    size_t uri_len, const uint8_t* expected_data,
...
ZTEST(orchestrator_app_full_processing_tests, test_valid_envelope_payload_fetch)
{
	...
	check_cache_slot_content(0, "payload1.bin", sizeof("payload1.bin"),
				 payload1, sizeof(payload1));
	check_cache_slot_content(1, "payload2.bin", sizeof("payload2.bin"),
				 payload2, sizeof(payload2));
	check_cache_slot_content(3, "payload3.bin", sizeof("payload3.bin"),
