...
FAKE_VALUE_FUNC(int, suit_plat_check_digest, enum suit_cose_alg,	struct zcbor_string *, struct zcbor_string *);
FAKE_VALUE_FUNC(int, suit_plat_authenticate_manifest, struct zcbor_string *, enum suit_cose_alg, struct zcbor_string *,	struct zcbor_string *, struct zcbor_string *);
...
FAKE_VALUE_FUNC(int, suit_plat_check_image_match, suit_component_t, enum suit_cose_alg, struct zcbor_string *);
...
FAKE_VALUE_FUNC(int, suit_plat_authorize_sequence_num, enum suit_command_sequence, struct zcbor_string *, unsigned int);
FAKE_VALUE_FUNC(int, suit_plat_authorize_component_id, struct zcbor_string *, struct zcbor_string *);
...
FAKE_VALUE_FUNC(int, suit_plat_sequence_completed, enum suit_command_sequence, struct zcbor_string *, const uint8_t *, size_t);
FAKE_VALUE_FUNC(int, suit_plat_retrieve_manifest, suit_component_t, uint8_t **, size_t *);
